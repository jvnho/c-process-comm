...
all:clean test_creation test_envoi test_reception test_anon ext2 test_droitwr test_droitrd
...
test_droitwr: m_file.o
	$(CC) $(CFLAGS) test_droitwr.c -o test_droitwr m_file.o $(LDFLAGS)

test_droitrd: m_file.o
	$(CC) $(CFLAGS) test_droitrd.c -o test_droitrd m_file.o $(LDFLAGS)
